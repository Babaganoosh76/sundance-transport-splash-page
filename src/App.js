...
function App() {
	...
	return (
		<div className="App">
			<header className="position-relative" style={{background: `url(${banner}) center/cover`,height:'35vh'}}>
				<div className="d-flex flex-column justify-content-center text-center text-white h-100" style={{background:'rgba(0,0,0,0.5)'}}>
					<h1><span className="b">S</span>undance <span className="b">T</span>ransport, Inc.</h1>
					<p className="lead"><i>&mdash; Established 1995 &mdash;</i></p>
				</div>
			</header>
			
			{/* Desktop Navbar */}
			<div className="desktopNavContainer d-none d-md-block">
				<div id="desktopNav" className="col-sm-3 bg-dark py-3">
					
					<div className="spinner" style={{height: '160px'}}>
						<img src={ sunburst } className="sunburst" style={{transform: 'rotate(0deg)'}} alt="Sundance Transport sunburst logo"/>
					</div>
					<nav className="navbar p-0">
						<ul className="list-unstyled text-center w-100">
							<li className=""><a className="py-3" href="#services">SERVICES</a></li>
							<li className=""><a className="py-3" href="#trucking">TRUCKING</a></li>
							<li className=""><a className="py-3" href="#equipment">EQUIPMENT</a></li>
							<li className=""><a className="py-3" href="#team">MEET THE OWNERS</a></li>
							<li className=""><a className="py-3" href="#contact">CONTACT US</a></li>
						</ul>
					</nav>

					<hr className="mx-auto" style={{background:'#bbb','maxWidth':'200px'}} />

					<p className="lead text-center text-light m-0"><i>Visit our socials!</i></p>
					<ul className="text-center list-unstyled list-social py-3">
						<li><a href="https://www.facebook.com/sundancetransportinc" target="example" title="Visit Sundance Transport on Facebook"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 310 310" fill="currentColor"><path d="M81.703,165.106h33.981V305c0,2.762,2.238,5,5,5h57.616c2.762,0,5-2.238,5-5V165.765h39.064 c2.54,0,4.677-1.906,4.967-4.429l5.933-51.502c0.163-1.417-0.286-2.836-1.234-3.899c-0.949-1.064-2.307-1.673-3.732-1.673h-44.996	V71.978c0-9.732,5.24-14.667,15.576-14.667c1.473,0,29.42,0,29.42,0c2.762,0,5-2.239,5-5V5.037c0-2.762-2.238-5-5-5h-40.545 C187.467,0.023,186.832,0,185.896,0c-7.035,0-31.488,1.381-50.804,19.151c-21.402,19.692-18.427,43.27-17.716,47.358v37.752H81.703 c-2.762,0-5,2.238-5,5v50.844C76.703,162.867,78.941,165.106,81.703,165.106z"/></svg></a></li>
						<li><a href="https://www.linkedin.com/company/sundance-transport-inc" target="example" title="Visit Sundance Transport on LinkedIn"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 310 310" fill="currentColor"><path d="M72.16,99.73H9.927c-2.762,0-5,2.239-5,5v199.928c0,2.762,2.238,5,5,5H72.16c2.762,0,5-2.238,5-5V104.73 C77.16,101.969,74.922,99.73,72.16,99.73z"/><path d="M41.066,0.341C18.422,0.341,0,18.743,0,41.362C0,63.991,18.422,82.4,41.066,82.4 c22.626,0,41.033-18.41,41.033-41.038C82.1,18.743,63.692,0.341,41.066,0.341z"/><path d="M230.454,94.761c-24.995,0-43.472,10.745-54.679,22.954V104.73c0-2.761-2.238-5-5-5h-59.599 c-2.762,0-5,2.239-5,5v199.928c0,2.762,2.238,5,5,5h62.097c2.762,0,5-2.238,5-5v-98.918c0-33.333,9.054-46.319,32.29-46.319 c25.306,0,27.317,20.818,27.317,48.034v97.204c0,2.762,2.238,5,5,5H305c2.762,0,5-2.238,5-5V194.995 C310,145.43,300.549,94.761,230.454,94.761z"/></svg></a></li>
						<li><a href="https://g.page/sundance-transport?share" target="example" title="Visit Sundance Transport on Google"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 210 210" fill="currentColor"><path d="M0,105C0,47.103,47.103,0,105,0c23.383,0,45.515,7.523,64.004,21.756l-24.4,31.696C133.172,44.652,119.477,40,105,40 c-35.841,0-65,29.159-65,65s29.159,65,65,65c28.867,0,53.398-18.913,61.852-45H105V85h105v20c0,57.897-47.103,105-105,105 S0,162.897,0,105z"/></svg></a></li>
						<li><a href="https://www.yelp.com/biz/sundance-transport-el-dorado-hills-3" target="example" title="Visit Sundance Transport on Yelp"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 98 98" fill="currentColor"><path d="M42.117,0.022c-6.995,0.42-13.626,2.332-19.86,5.498c-3.151,1.599-3.525,3.392-1.647,6.366 c6.502,10.299,13.004,20.597,19.544,30.872c0.683,1.073,1.498,2.123,2.453,2.95c2.367,2.048,5.353,1.168,6.183-1.833 c0.378-1.372,0.365-2.852,0.484-3.878c-0.823-12.203-1.6-23.979-2.419-35.754C46.624,0.942,45.452-0.178,42.117,0.022z"/><path d="M60.41,55.08c0.344-0.049,0.775-0.072,1.188-0.174c6.864-1.708,13.734-3.396,20.583-5.158 c3.014-0.775,3.979-2.483,2.888-5.407c-2.019-5.402-5.175-10.112-9.399-14.036c-2.274-2.113-4.274-1.875-6.114,0.591 c-4.296,5.758-8.53,11.562-12.795,17.342c-1.034,1.4-1.111,2.883-0.308,4.38C57.271,54.141,58.545,55.028,60.41,55.08z"/><path d="M40.762,58.363c0.09-2.102-0.806-3.545-2.843-4.38c-6.446-2.641-12.896-5.272-19.363-7.863 c-3.274-1.312-5.189-0.451-5.968,3c-0.704,3.118-1.132,11.078-0.424,16.727c0.606,2.796,2.313,3.719,5.021,2.881 c6.81-2.104,13.599-4.274,20.39-6.438C39.69,61.613,40.676,60.354,40.762,58.363z"/><path d="M83.524,70.723c-7.013-2.346-14.021-4.7-21.041-7.022c-1.711-0.566-3.19-0.053-4.328,1.31 c-1.189,1.426-1.708,3.087-0.688,4.759c3.974,6.493,7.999,12.954,12.067,19.388c0.983,1.558,2.55,1.891,4.234,1.086 c0.719-0.342,1.41-0.794,2.008-1.318c3.871-3.393,7.028-7.358,9.358-11.956c0.45-0.892,0.673-1.898,1.001-2.853 C86.036,72.305,85.123,71.258,83.524,70.723z"/><path d="M48.922,72.397c-0.01-2.089-0.826-3.312-2.596-4.016c-1.891-0.75-3.649-0.406-4.964,1.142 c-4.693,5.526-9.372,11.064-14.004,16.641c-1.751,2.11-1.568,4.105,0.696,5.659c4.998,3.427,10.57,5.484,16.606,6.082 c2.706,0.267,4.107-1.187,4.137-3.917c0.041-3.599,0.01-7.197,0.01-10.796c0.041,0,0.081,0,0.12,0 C48.927,79.594,48.941,75.995,48.922,72.397z"/></svg></a></li>
					</ul>
			...
			{/* Mobile Navbar*/}
			<nav className="navbar fixed-top navbar-expand-lg navbar-dark bg-dark p-0 d-md-none">
				<div className="container-fluid">
					<a className="navbar-brand" href="/" title="Sundance Transport homepage">
						<img src={ sunburst } width="60" height="30" style={{'objectFit':'cover','objectPosition':'top'}} alt="Sundance Transport sunburst logo"/>
					</a>
					<button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#NavbarMobile" aria-controls="NavbarMobile" aria-expanded="false" aria-label="Toggle navigation">
					...
					<div className="collapse navbar-collapse" id="NavbarMobile">
						<div className="navbar-nav">
							...
							<a className="nav-link" href="#trucking" title="Trucking">TRUCKING</a>
							<a className="nav-link" href="#equipment" title="Equipment">EQUIPMENT</a>
							<a className="nav-link" href="#team" title="Meet the Owners">MEET THE OWNERS</a>
							<a className="nav-link" href="#contact" title="Contact Us">CONTACT US</a>
						</div>
					</div>
				</div>
			</nav>
			...
			<section id="services" className="bg-white">
				<div className="container py-5">
					<div className="offset-sm-3 col-sm-9">
						<h2 className=""><span className="b">O</span>ur <span className="b">S</span>ervices</h2>
						<div className="row">

							<div className="col-md-4">
								<div className="card text-center h-100">
									<img src={ img_svc_1 } className="card-img-top" alt="flatbed trucking services" />
									<div className="card-body">
										<h3 className="card-title">TRUCKING</h3>
										<p className="card-text">Our <b>single-point-of-contact</b> strategy ensures adaptability needed to follow contractors’ specifications.</p>
										<a href="#trucking" title="Learn about our trucking services">Learn More</a>
									</div>
								</div>
							</div>
							...
							<div className="col-md-4">
								<div className="card text-center h-100">
									<img src={ img_svc_2 } className="card-img-top" alt="pick-up hotshot loads" />
									<div className="card-body">
										<h3 className="card-title">HOTSHOT LOADS</h3>
										<p className="card-text">Our hotshot trucks can carry smaller loads into <b>hard-to-reach</b> jobsites for a reduced cost.</p>
										<a href="#trucking" title="Learn about our hotshot services">Learn More</a>
									</div>
								</div>
							</div>
							...
							<div className="col-md-4">
								<div className="card text-center h-100">
									<img src={ img_svc_3 } className="card-img-top" alt="piggy-back forklift service" />
									<div className="card-body">
										<h3 className="card-title">FORKLIFTS</h3>
										<p className="card-text">We have piggy-back forklifts to handle <b>jobsite delivery</b>.</p>
										<a href="#trucking" title="Learn about our forklift services">Learn More</a>
									</div>
								</div>
							</div>
						</div>
			...
			{/*<!-- Trucking -->*/}
			<section id="trucking" className="bg-grey">
				<div className="container py-5">
					<div className="offset-sm-3 col-sm-9">
						<h2><span className="b">O</span>ur <span className="b">S</span>pecialties</h2>
						<div className="row text-center">
							<div className="col-sm-4 my-3">
								...
								<h3 className="my-3">FLEXIBILITY</h3>
								<p>We can accommodate next day deliveries and adapt to dynamic construction schedule changes.</p>
							</div>
							<div className="col-sm-4 my-3">
								<span id="glyphicon-trailer"><img src={ glp_trailer } height="54" alt="trailer glyphicon"/></span>
								<h3 className="my-3">TRAILERS</h3>
							...
							<div className="col-sm-4 my-3">
								...
								<h3 className="my-3">WIDE LOADS</h3>
							...
							<div className="col-sm-4 my-3">
								...
								<h3 className="my-3">SUSTAINABILITY</h3>
							...
							<div className="col-sm-4 my-3">
								...
								<h3 className="my-3">DELIVERY RANGE</h3>
								<p>We service Northern &amp; Central California.</p>
							</div>
							<div className="col-sm-4 my-3">
								<span id="glyphicon-forklift"><img src={ glp_forklift } height="54" alt="forklift-glyphicon"/></span>
								<h3 className="my-3">FORKLIFTS</h3>
			...
			<section id="equipment" className="bg-white">
				<div className="container py-5">
					<div className="offset-sm-3 col-sm-9">
						<h2><span className="b">O</span>ur <span className="b">E</span>quipment</h2>
						<div className="row g-0">
							...
							<div className="col-md-5"><img src={ img_gly_11 } className="w-100 h-100" alt="hotshot load" /></div>

							<div className="col-md-5"><img src={ img_gly_1 } className="w-100 h-100" alt="big-rig truck carrying a wide load" /></div>

							<div className="col-md-3"><img src={ img_gly_4 } className="w-100 h-100" alt="forklift unloading a flatbed trailer" /></div>

							<div className="col-md-4"><img src={ img_gly_9 } className="w-100 h-100" alt="hotshot truck hauling lumber" /></div>

							<div className="col-md-6"><img src={ img_gly_13 } className="w-100 h-100" alt="hotshot truck hauling a tractor" /></div>
			...
			<section id="team" className="bg-grey">
				<div className="container py-5">
					...
					<div className="offset-sm-3 col-sm-9">
						<h2><span className="b">M</span>eet the <span className="b">O</span>wners</h2>
						...
						<div className="row">
							<div className="col-md-6">
								<div className="card mb-3">
									<div className="row g-0">
										<div className="col-md-4">
											<img src={ img_mtt_1 } className="card-img h-100" style={{'objectFit':'cover'}} alt="Rebecca Miller at Sundance Transport" />
										</div>
										<div className="col-md-8">
											<div className="card-body">
												<h3 className="card-title">Rebecca Miller</h3>
												<p className="card-text">CEO / Accounting<br/>Office: <a href="tel:19169332870">(916) 933-2870</a><br/>Mobile: <a href="tel:19162755915">(916) 275-5915</a></p>
											</div>
										</div>
									</div>
								</div>
							...
							<div className="col-md-6">
								<div className="card mb-3">
									<div className="row g-0">
										<div className="col-md-4">
											<img src={ img_mtt_2 } className="card-img h-100" style={{'objectFit':'cover'}} alt="Bryan Miller at Sundance Transport"/>
										</div>
										<div className="col-md-8">
											<div className="card-body">
												<h3 className="card-title">Bryan Miller</h3>
												<p className="card-text">COO / Dispatcher<br/>Office: <a href="tel:19169332870">(916) 933-2870</a><br/>Mobile: <a href="tel:19168708885">(916) 870-8885</a></p>
											</div>
										</div>
									</div>
								</div>
				...
				<div className="container py-5">
					<div className="row">
						...
						<div className="col-sm-6 text-center">
							<h2><span className="b">C</span>ontact <span className="b">U</span>s</h2>
						...
						<div className="col-sm-6">
							<h2 className="text-center"><span className="b">G</span>et a <span className="b">Q</span>uote</h2>
							<form action="https://formspree.io/sundancetransportinc@gmail.com" method="POST">
								...
								<div className="col-sm-12 form-group pb-3">
				...
				<div className="container py-5">
					<div className="row">
						<div className="col-12 col-md my-3">
							<img className="mb-2" src={ sunburst } alt="" width="60" height="30" style={{'objectFit':'cover','objectPosition':'top'}} />
							<h6 className="d-block">Sundance Transport, Inc.</h6>
							<small className="d-block text-muted">Copyright &copy; 2021</small>
							<small className="text-muted">Managed by <a href="https://amiller.space" target="_blank" rel="noreferrer" style={{'fontStyle': 'normal'}}>Adam Miller</a></small>
						</div>
						<div className="col-12 col-md my-3">
							<h5>Navigation</h5>
							<ul className="list-unstyled text-small">
								<li><a className="text-muted" href="#services">SERVICES</a></li>
								<li><a className="text-muted" href="#trucking">TRUCKING</a></li>
								<li><a className="text-muted" href="#equipment">EQUIPMENT</a></li>
								<li><a className="text-muted" href="#team">MEET THE OWNERS</a></li>
							</ul>
						</div>
						<div className="col-12 col-md my-3">
							<h5>Socials</h5>
							<ul className="list-unstyled list-social py-3">
